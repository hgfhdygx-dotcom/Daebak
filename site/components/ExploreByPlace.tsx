      ...
      <div className="mt-3 grid grid-cols-2 gap-2.5 sm:grid-cols-3 lg:grid-cols-4">
        {PLACES.map((p) => (
          <Link
            ...
            className="group flex items-center gap-2 rounded-2xl border border-line bg-surface px-3.5 py-3 text-sm transition-all duration-150 hover:border-accent/40 hover:shadow-sm"
          >
